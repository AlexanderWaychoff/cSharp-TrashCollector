    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TrashCollector.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(TrashCollector.Models.ApplicationDbContext context)
        {
            ...
            var customers = new List<Customer>
            {
                ...
                new Customer { FirstName = "Wasabobi", LastName = "Macaroni", StreetAddress = "18147 W Coffee Rd", City = "New Berlin", StateAbbreviated = "WI", ZipCode = 53151, IsOnVacation = true, RequestedPickUpDay = Weekday.Wednesday, ScheduledPickUpDay = Weekday.Wednesday, MonthlyCharge = 45, IsAdmin = false},
                new Customer { FirstName = "Glob", LastName = "Mang", StreetAddress = "15167 W Coffee Rd", City = "New Berlin", StateAbbreviated = "WI", ZipCode = 53151, IsOnVacation = false, RequestedPickUpDay = Weekday.Wednesday, ScheduledPickUpDay = Weekday.Wednesday, MonthlyCharge = 77, IsAdmin = false},
                new Customer { FirstName = "Indirectapus", LastName = "Supatceridni", StreetAddress = "16667 W Coffee Rd", City = "New Berlin", StateAbbreviated = "WI", ZipCode = 53151, IsOnVacation = false, RequestedPickUpDay = Weekday.Monday, ScheduledPickUpDay = Weekday.Wednesday, MonthlyCharge = 13, IsAdmin = false},
                new Customer { FirstName = "Mark", LastName = "Mate", StreetAddress = "18217 W Coffee Rd", City = "New Berlin", StateAbbreviated = "WI", ZipCode = 53151, IsOnVacation = false, RequestedPickUpDay = Weekday.Wednesday, ScheduledPickUpDay = Weekday.Saturday, MonthlyCharge = 21, IsAdmin = false}
